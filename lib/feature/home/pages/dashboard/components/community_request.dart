...
class CommunityRequest extends StatelessWidget {
  ...
  final Function(AccountCommunityDomain) onTap;

  const CommunityRequest(
      {super.key, required this.accountCommunity, required this.onTap});

  @override
  Widget build(BuildContext context) => GestureDetector(
        onTap: () => onTap(accountCommunity),
        child: Stack(
          children: [
            Container(
              margin: EdgeInsets.only(
                  top: Spacing.extraSmall_h, bottom: Spacing.extraSmall_h),
